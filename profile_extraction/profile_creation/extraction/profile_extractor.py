...
def extract_profiles(chat: Chat, sequence_tagger: SequenceTagger, summary_only: bool) -> ProfileCollection:
    """
    ...
    for user in chat.users:
        ...
        message_results = prepare_messages(chat.get_messages_for_user(user), sequence_tagger)
...
def prepare_messages(messages: Iterable[Message], sequence_tagger: SequenceTagger) -> List[Tuple[Message, Sentence]]:
    """
    ...
    sequence_tagger.predict(sentences, mini_batch_size=16, label_name="ner")
